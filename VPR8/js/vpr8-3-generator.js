/**
 * VPR 8 Class - Task 3 Generator
 * Задание 3: Сложение в системах счисления столбиком
 */
...
function generateNewTask() {
  ...
  // Генерируем два числа для сложения (от 100 до 999 в десятичной)
  ...
  document.getElementById("taskText").innerHTML = `
    Выполните сложение: ${num1Str}${subscripts[base]} + ${num2Str}${subscripts[base]}.<br>
...
function checkAnswer() {
  ...
  if (window.VPR7_Storage) VPR7_Storage.saveTaskResult('8', 3, userAnswer === currentAnswer);
...
function showHint() {
  ...
  hintBox.innerHTML = `<strong>💡 Подсказка:</strong><br>Складывайте числа столбиком справа налево. Если сумма цифр в разряде больше или равна основанию системы — вычтите основание и перенесите единицу в следующий разряд. Переводить в десятичную систему не нужно!`;
