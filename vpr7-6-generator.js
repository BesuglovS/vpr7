...
const wordSets = [
  ...
  {
    letters: ["В", "О", "Л", "А", "К", "С"],
    words: ["ВОЛК", "СЛОВО", "КЛАСС", "ЛАВКА", "ВОСК", "КЛАС", "СОВА", "ЛОСА"],
  },
  {
    letters: ["Р", "О", "Т", "А", "К", "С"],
    words: [
  ...
  {
    letters: ["Г", "О", "Р", "А", "М", "Т"],
    words: ["ГОРА", "ГРОТ", "РОГА", "ТОРГ", "ГРАММ", "ГРОМА", "РОГАТ", "МАРГО"],
  },
  {
    letters: ["Ш", "К", "О", "Л", "А", "Н"],
 ...
 * @returns {boolean} - True if direct Fano condition is satisfied
 */
 ...
 * @param {Array} codes - Array of code strings
 * @returns {boolean} - True if reverse Fano condition is satisfied
 */
 ...
 * @param {Array} symbols - Array of symbol characters
 * @param {number} minLength - Minimum code length
 * @param {number} maxLength - Maximum code length
 * @returns {Array} - Array of all possible code strings
 */
 ...
 * @param {Array} letters - Array of letters to encode
 * @param {Array} symbols - Array of symbol characters
 * @param {Array} existingCodes - Array of already used codes
 * @returns {Object} - Object mapping letters to codes
 */
 ...
 * @returns {Object} - Task object with word, encoded, codes, fanoType, symbols
 */
...
function generateTaskText(task) {
  ...
  taskText += '<br><div class="message-container" id="messageContainer"></div>';
  taskText +=
 ...
 * @param {string} fanoType - "direct" or "reverse"
 * @returns {string} - Fano condition explanation
 */
 ...
 * @param {Object} task - Task object from generateTask
 * @returns {Array} - Array of HTML hint step strings
 */
